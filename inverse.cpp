...
int main(int argc, char *argv[]){
    cout << "Please tell me the PARENT yaml and I will generate the result for you." << endl;
    if(argc!=3){
    ...
    *result_matrix = (*parent_matrix).inverse();
    cout << "result matrix: " << (*result_matrix)(0,3) << "," << 
                                    (*result_matrix)(1,3) << "," << 
                                    (*result_matrix)(2,3) << "," << endl;
    
    save_transformation_to_file(out_file,result_matrix,child1f,parent1f);
